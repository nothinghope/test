...
//testNet info
_contract.chain = 11155111;
_contract.bscScan = "https://sepolia.etherscan.io";


//controller contract address (not token address)
const _contractAddress = "0xAf4B2f0B53f9f4B7ADcAc341cF2676452F6E68a5";
    ...
    try {
        const wasAdded = await ethereum.request({
            ...
            params: {
                type: 'ERC20', 
                options: {
                    address: "00x4633Cd9A823Aaf49947620F7980CE4Acd7a010fE", // The address that the token is at.
                    symbol: "TEST", // A ticker symbol or shorthand, up to 5 chars.
                    decimals: "1", // The number of decimals in the token
